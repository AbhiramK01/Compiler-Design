...
| Program8.c   | Recursive descent parser for arithmetic expressions (E -> T E', T -> F T', F -> d | (E)).  | [Lab-Programs/Program8.c](Lab-Programs/Program8.c)  |
...
| Program14    | YACC top-down parser with Lex file (Program14.l and Program14.y) for validating arithmetic expressions using grammar after eliminating left recursion (E -> T E', E' -> + T E' | ε, T -> F T', T' -> * F T' | ε, F -> (E) | id). | [Lab-Programs/Program14/](Lab-Programs/Program14/)  |
